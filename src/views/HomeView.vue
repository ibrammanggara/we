<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Ibram Mangzxx..!</h1>
      <div class="py-2">
        <h1
      ...
      <br>
      <button @click="downloadResume" class="fadein-bot fade-500 flex items-center py-2 px-4 mx-auto text-sm font-medium rounded-lg border transition duration-300 md:py-2.5 md:px-5 md:mx-0 text-amber-200 border-amber-200 hover:bg-amber-200 hover:bg-opacity-10 bg-transparent focus:outline-none w-fit">
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://fileuplodsm.s3.amazonaws.com/file/Screenshot+from+2024-07-07+12-51-14.png">
    </div>
  </main>
</template>
...
export default {
  ...
  methods: {
    ...
    downloadResume() {
      ...
      // link.href = 'pdf/DudukanFO.pdf'; // Ganti dengan path file resume Anda
